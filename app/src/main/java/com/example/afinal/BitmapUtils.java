...
public class BitmapUtils {
    ...
    public static Bitmap getBitmapFromContentUri(ContentResolver contentResolver, Uri imageUri)
            throws IOException {
        Bitmap decodeBitmap = MediaStore.Images.Media.getBitmap(contentResolver, imageUri);
        ...
        return rotateBitmap(decodeBitmap, rotationDegrees, flipX, flipY);

    }
    private static int getExifOrientationTag(ContentResolver resolver, Uri imageUri) {
        // support parsing EXIF orientation tag from local file on the device.
